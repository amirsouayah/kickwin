...
export default function Sidebarorga({ routes, logo, dropdown, input }) {
    ...
    <>
      <Hidden smDown implementation="css">
        <Drawer variant="permanent" anchor="left" open>
          ...
          <p>Pending Competition</p>
          <p>Ongoing Competition</p>
...
Sidebarorga.defaultProps = {
  routes: [],
};

Sidebarorga.propTypes = {
